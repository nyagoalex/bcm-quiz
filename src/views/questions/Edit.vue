 ...
 <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          ...
          <router-link class="" :to="{ name: 'QuestionsShow', params: { id: $route.params.id }}">
  ...
  <div class="w-75 p-3 mx-auto" style="text-align: left">
    <div class="d-flex justify-content-between py-3">
      <h1 class="d-inline">Edit Question</h1>
    </div>

    <b-form @submit.prevent="editQuestion" class="inner-form text-left">
      <b-form-group
        id="fieldset-1"
